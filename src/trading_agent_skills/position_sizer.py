...
Margin uses ``trading_agent_skills.margin_calc`` for transparency, then cross-checks
...
from trading_agent_skills.decimal_io import D, floor_to_step
...
def _resolve_stop(
    ...
    if req.stop_price is not None:
        ...
        # Price-units distance. Used by hand-offs from price-action,
