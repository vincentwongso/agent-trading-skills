...
from trading_agent_skills.symbol_meta import _INDEX_TO_CURRENCIES


# Currency → liquid trading symbols (for the calendar-driven tier).
...
def symbols_for_currencies(
    ...
    *,
    ...
    """Map a set of currency codes to their liquid trading symbols.
